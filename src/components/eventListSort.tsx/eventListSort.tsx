  ...
  return (
    <div className="bg-white p-4 m-4 rounded-2xl">
      <div className="flex flex-wrap justify-around items-center gap-3 mb-4">
        <FilterToDate events={events} filters={filters} setFilters={setFilters} />
        <FilterToCategory events={events} filters={filters} setFilters={setFilters} />
        <FilterToLocation events={events} filters={filters} setFilters={setFilters} />
